...
| `APP_IDENTITY_MISMATCH`             | The installation belongs to a different GitHub App.                    | Install and select the verified [Conf2Git GitHub App](https://github.com/apps/conf2git).                                                                  |
